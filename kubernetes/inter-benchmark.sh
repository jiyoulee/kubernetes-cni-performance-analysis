...
kubectl exec memaslap-854f66c954-wmxfm -- /memcached_bench/libmemcached-1.0.15/clients/memaslap -B -c 512 -s 10.244.1.4:11211,10.244.1.5:11211 -T 16 -t 70s | dd status=none of=$FILE conv=notrunc oflag=append
